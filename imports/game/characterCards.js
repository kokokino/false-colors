...
export const CharacterCards = {
  ...
  cook: {
    ...
    specialtyLabel: 'None',
    strengthDisplay: '1 vs all threats',
    passiveDescription: 'Nourish: Once per round, restore 1 resolve to any crew member (5 meals per game). Use this during the action phase.',
    strategyTips: [
      'Your fight strength is low — prioritize using Nourish on crew members at 0 resolve to prevent their penalty.',
      'Save some meals for late-game rounds when resolve is scarce and every point matters.',
      'If you must fight, target the threat closest to completion where even 1 strength could tip it over.',
    ],
    phantomTips: [
