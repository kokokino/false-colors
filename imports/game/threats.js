...
const threatDeck = [
  ...
  { type: ThreatType.REEF, name: 'The Maw', threshold: 6, doomPerRound: 2, description: 'A massive underwater formation that could tear the ship apart.' },
  ...
  { type: ThreatType.KRAKEN, name: 'Leviathan Rise', threshold: 7, doomPerRound: 2, description: 'The sea itself seems to rise against the ship.' },
  ...
  { type: ThreatType.STORM, name: 'Maelstrom', threshold: 7, doomPerRound: 2, description: 'The sea opens into a spinning vortex of destruction.' },
  ...
  { type: ThreatType.ILLNESS, name: 'Death Rattle', threshold: 6, doomPerRound: 2, description: 'The crew wastes away as a deadly plague takes hold.' },
  ...
  { type: ThreatType.HULL_BREACH, name: 'Keelbreak', threshold: 7, doomPerRound: 2, description: 'The keel itself splinters — the ship is tearing apart.' },
];
